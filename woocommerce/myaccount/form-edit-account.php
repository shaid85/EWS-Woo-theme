...
<form class="woocommerce-EditAccountForm edit-account mb-5" action="" method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?>>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide pb-4">
	...
	<fieldset>
		<legend class="fw-medium mb-3"><?php esc_html_e('Password change', 'woocommerce'); ?></legend>
	...
	<p>
		...
		<button type="submit" class="woocommerce-Button my-4 button<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>" name="save_account_details" value="<?php esc_attr_e('Save changes', 'woocommerce'); ?>"><?php esc_html_e('Save changes', 'woocommerce'); ?></button>
