...
?>
<table class="shop_table woocommerce-checkout-review-order-table mb-1">
	<thead class="">
		<tr class="d-none">
	...
	<tbody>
		...
		?>
				<tr class="<?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
					<td class="w-100 border-0 p-0" colspan="2">
						<div class="product-name d-flex gap-3 w-100">
							<?php
							$_product = $cart_item['data'];
							$thumbnail = $_product->get_image(array(80, 80)); // Get product image
							?>
							<div class="product-thumbnail "><?php echo $thumbnail; ?></div>
							<div class="ptitle text-14 fw-medium">
								<?php
								echo wp_kses_post(
								...
								<?php
								// Subtotal
								echo '<span class="product-total d-block">';
								echo apply_filters(
								...
								?>
								<?php
								// Variation/meta data (e.g. color/size)
